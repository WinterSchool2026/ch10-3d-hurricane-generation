...
from src.unet.dataloader import Cloud3DDataModule
from src.unet.transforms import GeoSatTransform
from src.unet.model import Cloud3DFullSceneModel
...
def main(dataset_dir, batch_size, patch_size, lr, wd, T_max, eta_min,
    ...
    model = Cloud3DFullSceneModel(lr=lr,wd=wd,T_max=T_max, eta_min=eta_min)
    ...
    best_model = Cloud3DFullSceneModel.load_from_checkpoint(checkpoint_cb.best_model_path)
...
if __name__ == "__main__":
    ...
    T_max=100
    eta_min=1e-6
    dir_save = "/data/users/emiliano/ch10-3d-hurricane-generation/output/unet/"
    ...
    main(dataset_dir, batch_size, patch_size, lr, wd, T_max, eta_min,
         dir_save, exp_nm, file_nm,save_top_k, 
